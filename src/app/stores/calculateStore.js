...
class DataStore extends Store {
    ...
    updateContractAnnualSalary(value) {
        this.updateCalcs("contractannual",(wDays, hrPerDay, tax, selfEmploymentTax) => {
    ...
    updateContractHourlySalary(value) {
        this.updateCalcs("contracthourly",(wDays, hrPerDay, tax, selfEmploymentTax) => {
    ...
    updateTakeHomeAnnualSalary(value) {
        this.updateCalcs("takehomeannually",(wDays, hrPerDay, tax, selfEmploymentTax) => {
    ...
    updateTakeHomeMonthlySalary(value) {
        this.updateCalcs("takehomemonthly",(wDays, hrPerDay, tax, selfEmploymentTax) => {
    ...
    updateW2AnnualSalary(value) {
        this.updateCalcs("w2annually",(wDays, hrPerDay, tax, selfEmploymentTax) => {
    ...
    updateW2HourlySalary(value) {
        this.updateCalcs("w2hourly",(wDays, hrPerDay, tax, selfEmploymentTax) => {
